 ...
 const o: Vec3 = [0, -1, 0]; // Camera origin.
 ...
 const birdRotation: Matrix4 = matrix3ToMatrix4(rotX(-90) as Matrix3);
 ...
 for (let i = 0; i <= 1; i += 0.1) { // Loop to create frames for the animation, with rotation from 0 to 360 degrees.
   ...
   framebuffer.save("bird." + ++currentFrame); // Save the current frame with an incremented frame number.
 }
